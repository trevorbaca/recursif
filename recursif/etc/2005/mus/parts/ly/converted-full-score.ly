{%
   ...
   Steps:
      ...
      1. convert-ly (from 2.7.11 source to 2.12.0)
      2. manual search and replace in vi for the following:
         2a. tuplet number fraction formatting
         2b. comment out two call-backs that no longer work
         2c. remove c'4[ c'4] type beams to avoid interpreter warnings
