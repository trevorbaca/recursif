...
{                                                                              %! baca.SingleStaffScoreTemplate.__call__()
    currentBarNumber = #49                                                     %! baca.SingleStaffScoreTemplate.__call__()
}                                                                              %! baca.SingleStaffScoreTemplate.__call__()
<<                                                                             %! baca.SingleStaffScoreTemplate.__call__()
    ...
    <<                                                                         %! abjad.ScoreTemplate._make_global_context()
        ...
        %@% \bacaStartTextSpanSPM                                              %! SPACING:baca.HorizontalSpacingSpecifier.__call__(2)
            ...
            % [Page_Layout measure 65]                                         %! baca.SegmentMaker._comment_measure_numbers():baca.SegmentMaker._style_phantom_measures(1):PHANTOM
