...
spacing = baca.make_layout(
    ...
    baca.page(
        ...
        baca.system(measure=221, y_offset=second + 10 * system, distances=distances),
        baca.system(measure=231, y_offset=second + 11 * system, distances=distances),
        baca.system(measure=241, y_offset=second + 12 * system, distances=distances),
        baca.system(measure=251, y_offset=second + 13 * system, distances=distances),
    ),
)
